...
function validateForm() {
  ...
  if (props.isSignUp && !formData.value.name.trim()) {
    ...
    isValid = false;
    document.querySelector('.BaseInput[name="name"]').classList.add('error');
  } else {
    document.querySelector('.BaseInput[name="name"]').classList.remove('error');
  }
  ...
  if (!formData.value.login.trim()) {
    ...
    isValid = false;
    document.querySelector('.BaseInput[name="login"]').classList.add('error');
  } else {
    document.querySelector('.BaseInput[name="login"]').classList.remove('error');
  }
  ...
  if (!formData.value.password.trim()) {
    ...
    isValid = false;
    document.querySelector('.BaseInput[name="password"]').classList.add('error');
  } else {
    document.querySelector('.BaseInput[name="password"]').classList.remove('error');
  }

  return isValid;
}
const nameInput = document.querySelector('.BaseInput[name="name"]');
const loginInput = document.querySelector('.BaseInput[name="login"]');
const passwordInput = document.querySelector('.BaseInput[name="password"]);
