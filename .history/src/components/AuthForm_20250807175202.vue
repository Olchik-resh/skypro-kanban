...
const isFormInvalid = ref(true) // Инициализируем как true, чтобы кнопка была disabled при загрузке формы
...
function validateForm() {
  ...
  isFormInvalid.value = !isValid // Обновляем состояние формы
  return isValid
}
