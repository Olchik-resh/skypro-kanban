...
const error = ref('') // Объявляем переменную error
...
function validateForm() {
  ...
  let isValid = true
  error.value = '' // Используем error.value для доступа к значению реактивной переменной
  ...
  if (!isValid) {
    error.value = 'Пожалуйста, заполните все обязательные поля' // Устанавливаем значение error.value
  }
