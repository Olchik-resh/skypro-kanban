...
function validateForm() {
  let isValid = true;
      ...
      this.errors.value.name = false;
      this.errors.value.login = false;
      this.errors.value.password = false;

      if (this.formData.value && !this.formData.value.name.trim() && this.props.isSignUp) {
        this.errors.value.name = true;
        isValid = false;
      }

      if (!this.formData.value.login.trim()) {
        this.errors.value.login = true;
        isValid = false;
      }

      if (!this.formData.value.password.trim()) {
        this.errors.value.password = true;
        isValid = false;
      }
...
async function handleSubmit(event) {
  ...
  try {
    console.log('Попытка авторизации с данными:', this.formData.value)

    const data = this.props.isSignUp
      ? await signUp(this.formData.value)
      : await signIn({ login: this.formData.value.login, password: this.formData.value.password })
