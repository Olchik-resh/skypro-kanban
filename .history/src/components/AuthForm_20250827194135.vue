        ...
        <div class="modal">
          <div class="modal__block">
            ...
            <form class="modal__form-login" @submit.prevent="handleSubmit">
              ...
              <BaseInput
                :class="{ error: (formTouched || touched.name) && !validateName(formData.name) }"
                v-show="isSignUp"
                name="name"
                id="formname"
                placeholder="Имя"
              ...
              <!-- Поле email -->
              <BaseInput
                :class="{ error: (formTouched || touched.login) && !validateName(formData.login) }"
                type="email"
                name="login"
                id="formlogin"
              ...
              <BaseInput
                :class="{
                  error: (formTouched || touched.password) && !validateName(formData.password),
                }"
                type="password"
                name="password"
                id="formpassword"
...
const isFormInvalid = computed(() => {
  if (!formTouched.value) return false // Кнопка всегда активна, пока не тронули форму

  // После первого ввода/фокуса — включаем строгую валидацию
